...
Then the output will appear in Turtle format.
...
DELETE
WHERE { ?c skosxl:altLabel/skosxl:literalForm ?hidden}
...
An online version of the Skosify tool is (usually) available here: [https://code.google.com/p/skosify/](https://code.google.com/p/skosify/), and use as follows
